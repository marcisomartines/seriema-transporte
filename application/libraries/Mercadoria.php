...
class Mercadoria
{
    ...
    public function listarDeposito(){
        ...
        foreach($resultado as $res){
            ...
            $html .= "<a class='btn btn-danger btn-xs' id='excluir'  href='#' data-toggle='modal' data-target='#excluirModal-modal' onclick='$(\"#id_mercadoria_excluir\").val(".$res["id_mercadoria"].");$(\"#tipoExclusao\").val(1)'><i class='fa fa-close'></i> Excluir</a>";
            $html .= "</td>";
            $html .= "<tr>";
        }
...
//            $html .= "<a class='btn btn-warning btn-xs' href='#' data-toggle='modal' data-target='#inserirModal-modal' onclick='editarVolume(".$res["id_mercadoria"].");'><i class='fa fa-pencil'></i> Editar</a>";
            $html .= "<a class='btn btn-danger btn-xs' id='excluir'  href='#' data-toggle='modal' data-target='#excluirModal-modal' onclick='$(\"#id_mercadoria_excluir\").val(".$res["id_mercadoria"].");$(\"#tipoExclusao\").val(2)'><i class='fa fa-close'></i> Cancelar</a>";
            $html .= "</td>";
            $html .= "<tr>";
        }
...
//            $html .= "<a class='btn btn-warning btn-xs' href='#' data-toggle='modal' data-target='#inserirModal-modal' onclick='editarVolume(".$res["id_mercadoria"].");'><i class='fa fa-pencil'></i> Editar</a>";
            $html .= "<a class='btn btn-danger btn-xs' id='excluir'  href='#' data-toggle='modal' data-target='#excluirModal-modal' onclick='$(\"#id_mercadoria_excluir\").val(".$res["id_mercadoria"].");$(\"#tipoExclusao\").val(3)'><i class='fa fa-close'></i> Cancelar</a>";
            $html .= "</td>";
            $html .= "<tr>";
        }
...
//            $html .= "<a class='btn btn-success btn-xs' href='#' data-toggle='modal' data-target='#entregarModal-modal' onclick='$(\"#id_mercadoria_entregue\").val(".$res["id_mercadoria"].");'><i class='fa fa-arrow-up'></i> Entregar</a>";
//            $html .= "<a class='btn btn-warning btn-xs' href='#' data-toggle='modal' data-target='#inserirModal-modal' onclick='editarVolume(".$res["id_mercadoria"].");'><i class='fa fa-pencil'></i> Editar</a>";
            $html .= "<a class='btn btn-danger btn-xs' id='excluir'  href='#' data-toggle='modal' data-target='#excluirModal-modal' onclick='$(\"#id_mercadoria_excluir\").val(".$res["id_mercadoria"].");$(\"#tipoExclusao\").val(4)'><i class='fa fa-close'></i> Cancelar</a>";
            $html .= "</td>";
            $html .= "<tr>";
        }
